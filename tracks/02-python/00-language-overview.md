...
- [Обзор языка Go](../00-go/00-language-overview.md) — сравнение философии и особенностей Go
- [Основы JVM](../01-java/00-jvm-fundamentals.md) — сравнение с интерпретатором Python и байткодом

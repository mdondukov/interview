...
- [Ошибки и контекст в Go](../00-go/03-errors-context.md) — подход к обработке ошибок в Go
- [Исключения в Java](../01-java/09-exceptions.md) — сравнение исключений Python и Java

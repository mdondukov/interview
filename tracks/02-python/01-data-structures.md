...
- [Массивы и хеширование](../05-algorithms/01-arrays-hashing.md) — алгоритмические задачи на структуры данных
- [Коллекции Java](../01-java/02-collections.md) — сравнение коллекций Python и Java

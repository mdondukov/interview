...
- [Инструменты и тестирование в Go](../00-go/07-tooling-testing.md) — экосистема тестирования Go
- [Тестирование в Java](../01-java/12-testing.md) — JUnit и тестирование в JVM
- [Стратегии тестирования](../08-architecture/09-testing-strategies.md) — общие подходы к тестированию

...
- [Графы и алгоритмы](../05-algorithms/07-graphs.md) — алгоритмы маршрутизации и поиска кратчайшего пути
- [Партиционирование](../07-distributed-systems/06-partitioning.md) — геопространственное разделение данных

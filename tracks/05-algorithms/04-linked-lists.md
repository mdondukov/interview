...
- [Стеки и очереди](./05-stacks-queues.md) — структуры данных на основе связных списков
- [Sliding Window](./02-sliding-window.md) — техника двух указателей применима к спискам

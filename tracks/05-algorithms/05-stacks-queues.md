...
- [Связные списки](./04-linked-lists.md) — реализация стеков и очередей на списках
- [Деревья и обход](./06-trees-traversal.md) — использование стека для итеративного обхода
